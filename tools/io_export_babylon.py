...
class Mesh(FCurveAnimatable):
    def __init__(self, object, scene, startFace, forcedParent, nameID, exporter):
        ...
        ##Justin Modification of the script
        if 'script' in object.data:
            print(object.data['script'])
            self.name = object.name + str(nameID) + ":" + object.data['script']
        else:
            self.name = object.name + str(nameID)
        ##Justin End Modification of the script
...
class Camera(FCurveAnimatable):
    def __init__(self, camera):
        ...
        ##Justin Modification of Script
        if 'script' in camera.data:
            print(camera.data['script'])
            self.name = camera.name + ":" + camera.data['script']
        else:
            self.name = camera.name
        ##Justin End Modification of Script
